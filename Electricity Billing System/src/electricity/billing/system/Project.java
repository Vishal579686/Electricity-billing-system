...
public class Project extends JFrame implements ActionListener{
    ...
    Project() {
        ...
        master.add(updateinformation);
        
        JMenuItem viewinformation = new JMenuItem("View Information");
        viewinformation.setFont(new Font("monospaced", Font.PLAIN, 12));
        viewinformation.setBackground(Color.WHITE);
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/icon6.png"));
        Image image6 = icon4.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        viewinformation.setIcon(new ImageIcon(image1));
        ...
        Image image8 = icon4.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        ...
        Image image9 = icon5.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
